package com.gap.chat_app.activity.message;
...
import com.gap.chat_app.adapter.message.ChatGroupAdapter;
...
import com.gap.chat_app.service.CoreService;
import com.gap.chat_app.service.MyFirebaseMessagingService;
import com.gap.chat_app.service.Services;
import com.gap.chat_app.webservice.MyPostJsonService;
import com.gap.chat_app.widget.menudrawer.ListDrawer;
...
/*
        FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(new OnSuccessListener<InstanceIdResult>() {
            ...
            public void onSuccess(InstanceIdResult instanceIdResult) {
                ...
                sendTokenToServer(MyFirebaseMessagingService.getToken(ChatGroupListActivity.this));
            }
        });*/
