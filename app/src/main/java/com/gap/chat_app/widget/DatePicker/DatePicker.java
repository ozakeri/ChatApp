package com.gap.chat_app.widget.DatePicker;
...
import com.gap.chat_app.widget.DatePicker.components.DateItem;
import com.gap.chat_app.widget.DatePicker.components.JDF;
import com.gap.chat_app.widget.DatePicker.fragments.MonthFragment;
import com.gap.chat_app.widget.DatePicker.fragments.YearFragment;
import com.gap.chat_app.widget.DatePicker.interfaces.DateInterface;
import com.gap.chat_app.widget.DatePicker.interfaces.DateSetListener;
import com.gap.chat_app.widget.DatePicker.model.Check;
...
public class DatePicker extends DialogFragment
    ...
    @Subscribe
    public void customEventReceived(Check check) {
        onDone();
        dismiss();
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.year) {
         ...
         /*   SharedPreferences.Editor editor = DriverApplication.getInstance().getSharedPreferences().edit();
            editor.putString("checkClick", "month");
            editor.apply();*/
