package com.gap.chat_app.widget.persiandatepicker;
...
import com.gap.chat_app.widget.persiandatepicker.util.PersianCalendar;
import com.gap.chat_app.widget.persiandatepicker.util.PersianCalendarConstants;
import com.gap.chat_app.widget.persiandatepicker.util.PersianCalendarUtils;
 ...
 */
public class MonthlyPersianDatePicker extends LinearLayout {
    ...
    public MonthlyPersianDatePicker(Context context) {
        this(context, null, -1);
    }

    public MonthlyPersianDatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MonthlyPersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        dayNumberPicker.setVisibility(INVISIBLE);
        yearNumberPicker.setVisibility(INVISIBLE);
    ...
    public Date getDisplayDate_Day() {
        PersianCalendar displayPersianDate = new PersianCalendar();
        displayPersianDate.setPersianDate(yearNumberPicker.getValue(), monthNumberPicker.getValue(), dayNumberPicker.getValue()-1);
        return displayPersianDate.getTime();
    }
    ...
    public PersianCalendar getDisplayPersianDate1() {
        PersianCalendar displayPersianDate = new PersianCalendar();
        displayPersianDate.setPersianDate(yearNumberPicker.getValue(), monthNumberPicker.getValue(), dayNumberPicker.getValue()-1);
        return displayPersianDate;
    }
