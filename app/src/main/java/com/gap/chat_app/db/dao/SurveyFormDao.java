...
/** 
 * DAO for table "SURVEY_FORM".
*/
public class SurveyFormDao extends AbstractDao<SurveyForm, Long> {

    public static final String TABLENAME = "SURVEY_FORM";

    /**
     * Properties of entity SurveyForm.<br/>
    ...
    */
    ...
    public SurveyFormDao(DaoConfig config) {
        super(config);
    }
    
    public SurveyFormDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SURVEY_FORM\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SURVEY_FORM\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SurveyForm entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(SurveyForm entity) {
    ...
    /** @inheritdoc */
    @Override
    public SurveyForm readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SurveyForm entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SurveyForm entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SurveyForm entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
